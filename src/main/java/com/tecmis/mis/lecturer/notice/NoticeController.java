...
public class NoticeController implements Initializable {
    ...
    @FXML
    private void viewNotice(MouseEvent event){
        if (event.isPrimaryButtonDown() && event.getClickCount() == 2) {
            try {
                ...
                SeeNoticeControlloer senddata = fxmlLoader.getController();
                senddata.showInformation(noticeDetails.getTitle(),noticeDetails.getDate(),noticeDetails.getTime(),noticeDetails.getContent());
